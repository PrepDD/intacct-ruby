...
Gem::Specification.new do |s|
  ...
  s.authors = ["Jeremy Zornow".freeze, "Dan Powell".freeze, "James Barkley".freeze]
  s.bindir = "exe".freeze
  s.date = "2019-06-25"
  ...
  s.email = ["jeremy@zornow.com".freeze, "dan.powell@privateprep.com".freeze, "james@prepdd.com".freeze]
